...
function getResponse(message) {
    const responses = {
        'pilhas': 'Pilhas contêm substâncias tóxicas e não devem ser descartadas no lixo comum. O ideal é levá-las a pontos de coleta específicos, como supermercados ou centros de reciclagem de eletrônicos. Lembre-se de armazená-las em um recipiente seguro até o descarte. Descarte com consciência no ponto de descarte mais perto de você!',
        
        'cigarro eletrônico': 'Cigarros eletrônicos contêm baterias de lítio e componentes eletrônicos que precisam ser descartados corretamente. Para fazer isso, desmonte o dispositivo removendo a bateria e outras peças eletrônicas. Leve essas partes para um ponto de coleta de lixo eletrônico. Descarte com consciência no ponto de descarte mais perto de você!',

        'telefone': 'Para descartar um telefone antigo, o ideal é remover a bateria, cartão SIM e outros componentes. Verifique se a bateria pode ser reciclada separadamente e, em seguida, leve todas as peças a um centro de reciclagem de eletrônicos. Descarte com consciência no ponto de descarte mais perto de você!',

        'mouse': 'Para descartar um mouse, você pode desmontá-lo, separando a parte eletrônica do plástico. As partes eletrônicas devem ser levadas para centros de reciclagem de eletrônicos, enquanto as partes plásticas podem ser recicladas se o material for apropriado. Descarte com consciência no ponto de descarte mais perto de você!',

        'carregador': 'Carregadores são compostos de fios de cobre e plástico, ambos recicláveis. Leve-os a um ponto de coleta de lixo eletrônico. Se o cabo estiver danificado, tente separá-lo dos conectores para facilitar o processo de reciclagem. Descarte com consciência no ponto de descarte mais perto de você!',

        'teclado': 'Teclados podem ser desmontados para separar as partes plásticas e eletrônicas. Remova as teclas e o cabo (se for com fio), e leve tanto as partes eletrônicas quanto o plástico para pontos de coleta de eletrônicos. As teclas de plástico podem ser recicladas dependendo do tipo de material. Descarte com consciência no ponto de descarte mais perto de você!',

        'default': 'Por favor, procure por centros de reciclagem locais ou pergunte sobre um item específico. Descarte com consciência no ponto de descarte mais perto de você!'
    };
